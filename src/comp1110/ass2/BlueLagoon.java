...
//FIXME Task 10
    ...
    public static String generateCurrentStateStatement (int a){
        return " c " + a;
    }
    /**
...
//                applyMoveString = applyMoveString.replaceAll(" c "+);
    ...
    public static List<String> getMovesList (String gameState){
        Set<String> movesSet = generateAllValidMoves(gameState);
        List<String> movesList = new ArrayList<>(movesSet);
        return movesList;
    }
    ...
    public static String generateAIMove(String stateString){
        ...
        String bestMove;
        List<String> moves = getMovesList(stateString);
   ...
   // bestMove = moves.get(index);}
        /**
         * below random moves generated by AI
         * works fine
         * need to be improved
         */
        Random rand = new Random();
        int digitRand = rand.nextInt(moves.size());
